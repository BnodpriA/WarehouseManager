using WarehouseManager.Application.Extensions;
using WarehouseManager.Infrastructure.Extensions;
using WarehouseManager.Server.Extensions;
using WarehouseManager.Server.Middlewares;
using Hangfire;
...
using System.IO;
using WarehouseManager.Server.Filters;
using WarehouseManager.Server.Managers.Preferences;
using Microsoft.Extensions.Localization;

namespace WarehouseManager.Server
{
