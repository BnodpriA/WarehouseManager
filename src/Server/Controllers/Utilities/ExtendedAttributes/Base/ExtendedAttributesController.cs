...
using WarehouseManager.Application.Features.ExtendedAttributes.Commands.Delete;
...
using WarehouseManager.Application.Features.ExtendedAttributes.Queries.GetById;
using WarehouseManager.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace WarehouseManager.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
