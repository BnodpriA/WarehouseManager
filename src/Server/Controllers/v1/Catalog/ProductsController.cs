...
using WarehouseManager.Application.Features.Products.Commands.Delete;
using WarehouseManager.Application.Features.Products.Queries.Export;
using WarehouseManager.Application.Features.Products.Queries.GetAllPaged;
using WarehouseManager.Application.Features.Products.Queries.GetProductImage;
using WarehouseManager.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Threading.Tasks;

namespace WarehouseManager.Server.Controllers.v1.Catalog
{
