...
using AutoMapper;
using WarehouseManager.Application.Exceptions;
...
using WarehouseManager.Infrastructure.Specifications;
using WarehouseManager.Shared.Constants.Role;
...
namespace WarehouseManager.Infrastructure.Services.Identity
{
