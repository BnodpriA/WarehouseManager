...
using WarehouseManager.Client.Infrastructure.Managers;
...
using WarehouseManager.Client.Infrastructure.Managers.ExtendedAttribute;
using WarehouseManager.Domain.Entities.ExtendedAttributes;
using WarehouseManager.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace WarehouseManager.Client.Extensions
{
